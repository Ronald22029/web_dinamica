  ...
  <div class="boda-template modern-theme" :style="cssVars" v-if="invitation">
      ...
      <div class="container text-center">
        ...
        <div class="modern-music-bar" v-if="musicUrl">
            <div class="music-info">
                ...
                <span class="music-text">{{ isPlaying ? 'Reproduciendo Música...' : 'Música en Pausa' }}</span>
            </div>
            <!-- Progress Bar -->
            ...
            <div class="music-controls">
                <button @click="toggleAudio" class="ctrl-btn">{{ isPlaying ? '⏸' : '▶' }}</button>
    ...
    <section class="section rsvp-section">
      <div class="container text-center">
        ...
        <p class="text-muted mb-4">Por favor, confírmanos tu asistencia antes del {{ rsvpDeadline }}.</p>
        ...
        <div class="rsvp-form-card">
          ...
          <div class="form-group">
            ...
            <div class="radio-group">
              <button @click="rsvp.attending = 'si'" :class="{ active: rsvp.attending === 'si' }" class="radio-btn">Sí, asistiré</button>
              <button @click="rsvp.attending = 'no'" :class="{ active: rsvp.attending === 'no' }" class="radio-btn">No podré asistir</button>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea v-model="rsvp.message" placeholder="Déjanos un mensaje..." class="modern-input" rows="3"></textarea>
          </div>
